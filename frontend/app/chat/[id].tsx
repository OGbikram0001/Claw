...
export default function ChatScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: T.bg }}>
      {/* ── TOP BAR ── */}
      <View style={s.topBar}>
        <TouchableOpacity onPress={() => router.back()} activeOpacity={0.7} style={s.backBtn} accessibilityRole="button" accessibilityLabel="Go back" accessibilityState={{ disabled: false }}>
        ...
        <TouchableOpacity activeOpacity={0.7} style={s.menuBtn} accessibilityRole="button" accessibilityLabel="Options menu" accessibilityState={{ disabled: false }}>
      ...
      >
        ...
        <View style={s.inputWrap} pointerEvents="box-none">
          ...
          <View style={s.inputBox}>
            <TouchableOpacity activeOpacity={0.7} style={s.inputSide} accessibilityRole="button" accessibilityLabel="Attach file" accessibilityState={{ disabled: false }}>
