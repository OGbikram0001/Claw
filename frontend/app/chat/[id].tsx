...
export default function ChatScreen() {
  ...
  // Optimization: Use useCallback to preserve reference stability of handlers passed to list items,
  // preventing full list re-renders when parent state (like input text) changes.
