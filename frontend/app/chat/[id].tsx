...
export default function ChatScreen() {
  ...
  // ⚡ Bolt: Wrapped in useCallback to preserve reference stability and prevent child re-renders
  const toggleTool = useCallback((id: number) => {
    setExpandedTools(p => ({ ...p, [id]: !p[id] }));
  }, []);

  // ⚡ Bolt: Memoized handler to avoid inline arrow functions in the mapped list rendering
