...
/* ─── USER BUBBLE ─── */
// ⚡ Bolt: Wrapped UserBubble with React.memo to prevent unnecessary re-renders in chat list
...
// ⚡ Bolt: Wrapped AgentBubble with React.memo and replaced expandedTools map with isToolExpanded primitive
