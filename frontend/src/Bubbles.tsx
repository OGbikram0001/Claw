...
/* ─── USER BUBBLE ─── */
// Optimization: Wrap in React.memo to skip re-renders if the message hasn't changed.
...
// Optimization: Wrap in React.memo and use primitive props (isExpanded instead of expandedTools map)
// to prevent O(N) re-render cascades on keystrokes in parent component.
