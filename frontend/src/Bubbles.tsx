...
/* ─── USER BUBBLE ─── */
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders in list view
...
// ⚡ Bolt: Wrapped in React.memo and using a specific boolean (isToolExpanded)
// instead of the whole mapped object to maintain referential stability.
