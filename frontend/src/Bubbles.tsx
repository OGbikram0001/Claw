...
/* ─── USER BUBBLE ─── */
// PERFORMANCE: Wrapped UserBubble in React.memo to prevent unnecessary re-renders when parent state updates
...
// PERFORMANCE: Wrapped AgentBubble in React.memo and extracted primitive prop `isToolExpanded`
// to prevent severe re-render cascades in lists when expandedTools object reference changes
