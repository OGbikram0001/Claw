...
/* ─── USER BUBBLE ─── */
// Bolt Optimization: Added React.memo to prevent unnecessary re-renders of the entire list
...
// Bolt Optimization: Added React.memo to prevent unnecessary re-renders of the entire list
// and replaced expandedTools object with a primitive boolean prop isToolExpanded
