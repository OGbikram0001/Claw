...
/* ─── USER BUBBLE ─── */
// ⚡ Bolt: memoize list item component to prevent unnecessary re-renders
...
// ⚡ Bolt: memoize list item component and use primitive props to prevent unnecessary re-renders
