...
/* ─── USER BUBBLE ─── */
// ⚡ Bolt: Memoize component to prevent unnecessary re-renders when parent states (like input) change
...
// ⚡ Bolt: Memoize component and replace large mapping object with boolean primitive to preserve reference stability
