...
/* ─── USER BUBBLE ─── */
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders when parent text input updates
...
// ⚡ Bolt: Wrapped in React.memo and using primitive prop isToolExpanded instead of the whole map
