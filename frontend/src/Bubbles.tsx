...
/* ─── USER BUBBLE ─── */
// ⚡ Bolt: Wrapped UserBubble in React.memo to prevent unnecessary re-renders when parent state changes.
...
// ⚡ Bolt: Wrapped AgentBubble in React.memo and replaced Record prop with primitive boolean to prevent cascading re-renders.
