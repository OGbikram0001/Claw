...
/* ─── USER BUBBLE ─── */
// Wrapped in memo to prevent unnecessary re-renders when parent state (like input) changes
...
// Wrapped in memo and accepts primitive props to prevent unnecessary re-renders
