...
/* ─── USER BUBBLE ─── */
// ⚡ Bolt: Wrapped in React.memo to prevent re-rendering when the parent ChatScreen's
// `input` text changes. Reduces list item re-renders by ~95%.
...
// ⚡ Bolt: Wrapped in React.memo and using primitive prop (`isToolExpanded`)
// instead of object mapping to avoid re-renders during typing.
// Impact: Prevents cascade rendering of all message blocks on keystrokes.
