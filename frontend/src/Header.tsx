    ...
    <View style={styles.wrapper} pointerEvents="box-none">
      ...
      <View style={styles.row}>
        ...
        <Animated.View style={[{ flexDirection: "row", gap: 6 }, rightStyle]}>
          {view === "home" ? (
            <TouchableOpacity accessibilityRole="button" accessibilityLabel={`Overall progress ${overallProgress}%`} onPress={onProgressTap} activeOpacity={0.8} style={styles.rightPill}>
