        ...
        <Animated.View style={[{ flexDirection: "row", gap: 6 }, rightStyle]}>
          {view === "home" ? (
            <TouchableOpacity
              ...
              onPress={onProgressTap} activeOpacity={0.8} style={styles.rightPill}>
            ...
            <>
              <TouchableOpacity
                ...
                onPress={onNewChat} activeOpacity={0.8} style={styles.iconBtn}>
                <Ic name="create-outline" size={20} color={T.textPri} />
              </TouchableOpacity>
              <TouchableOpacity
                accessibilityRole="button"
                accessibilityLabel="Chat menu"
                onPress={onChatMenu} activeOpacity={0.8} style={styles.iconBtn}>
