    ...
    <View style={styles.wrapper} pointerEvents="box-none">
      ...
      <View style={styles.row}>
        ...
        <Animated.View style={[{ flexDirection: "row", gap: 6 }, rightStyle]}>
          {view === "home" ? (
            <TouchableOpacity onPress={onProgressTap} activeOpacity={0.8} style={styles.rightPill} accessibilityRole="button" accessibilityLabel={`Overall progress ${overallProgress} percent`}>
            ...
            <>
              ...
              <TouchableOpacity onPress={onChatMenu} activeOpacity={0.8} style={styles.iconBtn} accessibilityRole="button" accessibilityLabel="Chat menu">
