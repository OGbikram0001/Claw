    ...
    <View style={styles.wrapper} pointerEvents="box-none">
      ...
      {fabExpanded ? (
        ...
        <View style={styles.inner}>
          ...
          {/* FAB */}
          <TouchableOpacity onPress={() => setFabExpanded(true)} activeOpacity={0.85} style={styles.fab} accessibilityRole="button" accessibilityLabel="Expand chat options">
    ...
    <View style={inputStyles.row}>
      ...
      <View style={inputStyles.box}>
        ...
        <TouchableOpacity onPress={onSubmit} activeOpacity={0.8}
          ...
          accessibilityLabel={newChatText.trim() ? "Send message" : "Record voice message"}
        >
