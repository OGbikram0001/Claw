    ...
    <View style={styles.wrapper} pointerEvents="box-none">
      ...
      {fabExpanded ? (
        ...
        <View style={styles.inner}>
          ...
          {/* FAB */}
          <TouchableOpacity accessibilityRole="button" accessibilityLabel="Add New" onPress={() => setFabExpanded(true)} activeOpacity={0.85} style={styles.fab}>
...
function NavTab({ tab, active, onPress }: { tab: typeof TABS[number]; active: boolean; onPress: () => void }) {
  ...
  return (
    <TouchableOpacity accessibilityRole="button" accessibilityLabel={tab.label} onPress={onPress} activeOpacity={0.7} style={styles.navTab}>
...
function ChatInput({ newChatText, setNewChatText, onSubmit, onClose, showClose }: {
  ...
  return (
    <View style={inputStyles.row}>
      {showClose && (
        <TouchableOpacity accessibilityRole="button" accessibilityLabel="Close Input" onPress={onClose} activeOpacity={0.8} style={inputStyles.sideBtn}>
      ...
      <View style={inputStyles.box}>
        ...
        />
        <TouchableOpacity accessibilityRole="button" accessibilityLabel={newChatText.trim() ? "Send Message" : "Record Audio"} onPress={onSubmit} activeOpacity={0.8}
