    ...
    <View style={styles.wrapper} pointerEvents="box-none">
      ...
      {fabExpanded ? (
        ...
        <View style={styles.inner}>
          ...
          {/* FAB */}
          <TouchableOpacity onPress={() => setFabExpanded(true)} activeOpacity={0.85} style={styles.fab} accessibilityRole="button" accessibilityLabel="Expand FAB">
  ...
  return (
    <View style={inputStyles.row}>
      ...
      <View style={inputStyles.box}>
        <TouchableOpacity activeOpacity={0.7} style={inputStyles.attach} accessibilityRole="button" accessibilityLabel="Attach">
