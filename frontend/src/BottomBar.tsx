    ...
    <View style={styles.wrapper} pointerEvents="box-none">
      ...
      <View style={[styles.fabContainer, fabExpanded ? styles.fabContainerExpanded : null]}>
        <GlassPill style={[{ width: "100%", height: "100%" }, { borderColor: T.amber + "55" }]} rounded={28}>
          {!fabExpanded ? (
            <TouchableOpacity accessibilityRole="button" accessibilityLabel="New Message" activeOpacity={0.8} onPress={() => setFabExpanded(true)} style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
...
function NavBtn({ icon, iconActive, label, active, onPress }: any) {
  ...
  return (
    <TouchableOpacity accessibilityRole="button" accessibilityLabel={label} accessibilityState={{ selected: active }} activeOpacity={0.85} onPress={onPress}>
      <Animated.View style={[
        {
