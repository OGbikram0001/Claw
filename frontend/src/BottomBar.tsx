    ...
    <View style={styles.wrapper} pointerEvents="box-none">
      ...
      {fabExpanded ? (
        ...
        <View style={styles.inner}>
          ...
          {/* FAB */}
          <TouchableOpacity onPress={() => setFabExpanded(true)} activeOpacity={0.85} style={styles.fab} accessibilityRole="button" accessibilityLabel="New Message">
...
function NavTab({ tab, active, onPress }: { tab: typeof TABS[number]; active: boolean; onPress: () => void }) {
  ...
  return (
    <TouchableOpacity onPress={onPress} activeOpacity={0.7} style={styles.navTab} accessibilityRole="tab" accessibilityLabel={tab.label}>
    ...
    <View style={inputStyles.row}>
      ...
      <View style={inputStyles.box}>
        ...
        <TouchableOpacity onPress={onSubmit} activeOpacity={0.8}
          style={[inputStyles.sendBtn, { backgroundColor: newChatText.trim() ? T.amber : T.card }]} accessibilityRole="button" accessibilityLabel={newChatText.trim() ? "Send Message" : "Record Audio"}>
