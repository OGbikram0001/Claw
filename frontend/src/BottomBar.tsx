          ...
          {!fabExpanded ? (
            ...
            <View style={{ flexDirection: "row", flex: 1, alignItems: "center", paddingHorizontal: 6, gap: 4 }}>
              ...
              {newChatText.length > 0 ? (
                ...
                <TouchableOpacity accessibilityRole="button" accessibilityLabel="Use voice input" style={iconBtnStyle}>
...
function NavBtn({ icon, iconActive, label, active, onPress }: any) {
  ...
  return (
    <TouchableOpacity accessibilityRole="button" accessibilityState={{ selected: active }} accessibilityLabel={label} activeOpacity={0.85} onPress={onPress}>
      <Animated.View style={[
        {
